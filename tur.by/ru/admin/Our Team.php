...
<meta property="og:type" content="website">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link rel="stylesheet" href="Our_Team_files/assets.css">
        <style>
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Our_Team_files/styles.css" id="moto-website-style"> 
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_1"><span class="moto-color1_3"></span><a href="Home.php" data-action="page" data-id="1" class="moto-link"><span class="moto-color1_3">ParisTravel</span></a><span class="moto-color1_3"></span><br></p></div>
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_2">Мы всегда готовы вам помочь</p><h1 class="moto-text_system_5">Наша команда</h1></div>
</div>   
</div>
 </div>
    </div>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6">Мы являемся туристическим агентством</h2><p class="moto-text_normal">Проверьте наши самые популярные туры</p></div>
</div>
        
    
        
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_10">Мы предлагаем широкий спектр захватывающих туров и приключенческих мероприятий в Гродно по доступным ценам.</p><p class="moto-text_system_10"><br></p><ul><li class="moto-text_system_14"><a href="#" target="_self" data-action="url" class="moto-link">Экскурсия по г.Гродно и его окрестностям</a><br></li><li class="moto-text_system_14"><a href="#" target="_self" data-action="url" class="moto-link">Тур с местным жителем</a><br></li><li class="moto-text_system_14"><a href="#" target="_self" data-action="url" class="moto-link">Лучшие рестораны в Гродно</a><br></li><li class="moto-text_system_14"><a href="#" target="_self" data-action="url" class="moto-link">Лучшие отели в Гродно</a><br></li><li class="moto-text_system_14"><a href="#" target="_self" data-action="url" class="moto-link">Гроно в фотографиях: прогулка, улицы, щелчок</a><br></li></ul></div>
</div>
            ...
            <div data-widget-id="wid__image__5c102433e26e2" class="moto-widget moto-widget-image moto-preset-default moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img data-src="Our_Team_files/our.jpg" class="moto-widget-image-picture lazyloaded" data-id="" title="" alt="" src="Our_Team_files/our.jpg">
            </span>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6">Наша команда</h2><p class="moto-text_normal">Познакомьтесь с нашей командой опытных профессионалов</p></div>
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5c102433e2e7b" class="moto-widget moto-widget-image moto-preset-default moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img data-src="Our_Team_files/mt-1132-about-img02.jpg" class="moto-widget-image-picture lazyloaded" data-id="" title="" alt="" src="Our_Team_files/mt-1132-about-img02.jpg">
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 style="text-align: center;" class="moto-text_system_12">Елена Заяц</h3><h3 style="text-align: center;" class="moto-text_system_12">&nbsp;</h3><p style="text-align: center;" class="moto-text_215">РУКОВОДИТЕЛЬ ПРОЕКТА</p></div>
</div>
...
<div class="moto-widget moto-widget-row__column moto-cell col-sm-3" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
            ...
            <div data-widget-id="wid__image__5c102433e3186" class="moto-widget moto-widget-image moto-preset-default moto-align-center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img data-src="Our_Team_files/mt-1132-about-img03.jpg" class="moto-widget-image-picture lazyloaded" data-id="" title="" alt="" src="Our_Team_files/mt-1132-about-img03.jpg">
            </span>
            </div>
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 style="text-align: center;" class="moto-text_system_12">Владисав Жордочкин</h3><h3 style="text-align: center;" class="moto-text_system_12">&nbsp;</h3><p style="text-align: center;" class="moto-text_215">СОЗДАТЕЛЬ САЙТА</p></div>
</div>    
</div>
</div>
    </div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="-" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_10">Copyright 2020&nbsp;- GrodnoTravel- <a data-action="page" data-id="18" class="moto-link" href="Privacy Policy">Все Права Защищены</a></p></div>
</div></div>
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="Our_Team_files/website.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="Our_Team_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
