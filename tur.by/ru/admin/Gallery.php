<?php
    ...
    require_once "Home_files/include/functions.php"; 

?>
<!DOCTYPE html>
<html data-ng-app="website" lang="ru"><head>
...
<meta property="og:type" content="website">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link rel="stylesheet" href="Gallery_files/assets.css">
        <style>
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Gallery_files/styles.css" id="moto-website-style">
...
</div><div class="moto-widget moto-widget-container undefined moto-container_header_5e43a1fc2 moto-sticky__bootstrapped" data-visible-on="" data-widget="container" data-container="container" data-css-name="moto-container_header_5e43a1fc2" data-bg-position="left top" data-moto-sticky="{}">
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <a href="Events.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-submenu moto-link">Факты<span class="fa moto-widget-menu-link-arrow"></span></a>
                <ul class="moto-widget-menu-sublist">
                    <li class="moto-widget-menu-item">
    <a href="Blog.php" data-action="blog.index" class="moto-widget-menu-link moto-widget-menu-link-level-3 moto-link">Блог</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="Contacts.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-3 moto-link">Контакты</a>
                    ...
                    <li class="moto-widget-menu-item">
    <a href="Testimonials.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-link">Рекомендация</a>
        </li>
            </ul>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_2">Наслаждайтесь незабываемым</p><h1 class="moto-text_system_5">Галерея</h1></div>
</div></div>
</div>
    </div>
</div></div>
...
</div><div class="moto-widget moto-widget-block row-fixed moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto" data-widget="block" data-spacing="lala" style="background-color:;" data-bg-position="left top">
    
    <div class="container-fluid">
        <div class="row">
            <div class="moto-cell col-sm-12" data-container="container">
                
            <div data-widget-id="wid__grid_gallery__5c1023f44f2d7" class="moto-widget moto-widget-grid-gallery moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="grid_gallery" data-preset="default" data-spacing="aaaa">
            <div class="moto-widget-grid-gallery-items justified-gallery" data-moto-grid-gallery-options="{&quot;rowHeight&quot;:250,&quot;fixedHeight&quot;:false,&quot;margins&quot;:20,&quot;lastRow&quot;:&quot;hide&quot;,&quot;showCaptions&quot;:true,&quot;enableLightbox&quot;:true,&quot;showCounter&quot;:true}" data-moto-init-lightbox-gallery="" data-lightbox-gallery-show-counter="" style="height: 905.263px;">
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 373px; height: 275.088px; top: 20px; left: 20px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="" class="moto-widget-grid-gallery-image moto-link" style="width: 373px; height: 276px; margin-left: -186.5px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 373px; height: 275.088px; top: 20px; left: 413px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img02.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 373px; height: 276px; margin-left: -186.5px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 374px; height: 275.088px; top: 20px; left: 806px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img03.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 374px; height: 276px; margin-left: -187px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 373px; height: 275.088px; top: 315.088px; left: 20px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img04.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 373px; height: 276px; margin-left: -186.5px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='5' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 373px; height: 275.088px; top: 315.088px; left: 413px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='5' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img05.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 373px; height: 276px; margin-left: -186.5px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='6' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 374px; height: 275.088px; top: 315.088px; left: 806px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='6' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img06.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 374px; height: 276px; margin-left: -187px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='7' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 373px; height: 275.088px; top: 610.175px; left: 20px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='7' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img07.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 373px; height: 276px; margin-left: -186.5px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='8' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 373px; height: 275.088px; top: 610.175px; left: 413px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='8' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img08.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 373px; height: 276px; margin-left: -186.5px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='9' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 374px; height: 275.088px; top: 610.175px; left: 806px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='9' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img09.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 374px; height: 276px; margin-left: -187px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='10' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 374px; height: 275.088px; top: 610.175px; left: 806px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='10' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img09.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 374px; height: 276px; margin-left: -187px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='11' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 374px; height: 275.088px; top: 610.175px; left: 806px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='11' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img09.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 374px; height: 276px; margin-left: -187px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
                            <a href="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='12' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" data-action="lightbox" data-moto-lightbox-item="" data-moto-lightbox-link="" class="moto-widget-grid-gallery-item jg-entry entry-visible" style="width: 374px; height: 275.088px; top: 610.175px; left: 806px;">
                    <img src="Gallery_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_gallerey WHERE gall_id='12' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" alt="mt-1132-gallery-img09.jpg" class="moto-widget-grid-gallery-image moto-link" style="width: 374px; height: 276px; margin-left: -187px; margin-top: -138px;">
                                                                        <div class="caption caption_text caption-empty" data-moto-lightbox-caption="">
                                <p></p>
                            </div>
                                                            </a>
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="Gallery_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="Gallery_files/website.js" type="text/javascript" data-cfasync="false"></script>
