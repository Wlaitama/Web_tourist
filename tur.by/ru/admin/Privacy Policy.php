...
<meta property="og:type" content="website">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link rel="stylesheet" href="Privacy_Policy_files/assets.css">
...
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Privacy_Policy_files/styles.css" id="moto-website-style">
</head>
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h1 class="moto-text_system_5">Политика Конфиденциальности</h1></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong>Главная информация</strong></p><p class="moto-text_system_10">
    Добро пожаловать на нашу страницу Политики конфиденциальности! Когда вы пользуетесь услугами нашего веб-сайта, вы
доверьте нам свою информацию. Эта политика конфиденциальности предназначена для того, чтобы помочь вам
поймите, какие данные мы собираем, почему мы их собираем и что мы делаем с ними
оно. Когда Вы делитесь с нами информацией, мы можем сделать наши услуги еще более выгодными
подходящий для вас. Например, мы можем показать вам более релевантный поиск
результаты и объявления, которые помогут вам связаться с людьми или сделать общий доступ с ними
другие быстрее и проще. Поскольку вы пользуетесь нашими услугами, мы хотим, чтобы Вы были
ясно, как мы используем информацию и как вы можете ее защитить
ваша конфиденциальность. Это очень важно; мы надеемся, что вы найдете время, чтобы прочитать его
внимательно. Помните, что вы можете найти элементы управления для управления вашей информацией
и защитить вашу частную жизнь и безопасность. Мы постарались сделать все как можно проще
по возможности.
</p><p class="moto-text_system_10"><br></p><p class="moto-text_214"><strong>Право на доступ, исправление и удаление данных, а также на возражение против обработки данных</strong></p><p class="moto-text_system_10">
Наши клиенты имеют право на доступ, исправление и удаление персональных данных
относящихся к ним, и возражать против обработки таких данных, путем
обращение с письменным запросом, в любое время. Компания делает все
усилия по принятию надлежащих мер предосторожности для обеспечения безопасности
и конфиденциальности персональных данных, а также для предотвращения их изменения,
поврежденные, уничтоженные или доступные несанкционированным третьим лицам. Однако,
компания не контролирует каждый риск, связанный с использованием
Интернет, и поэтому предупреждает пользователей сайта о потенциальных рисках
участвует в функционировании и использовании интернета. Сайт может
включите ссылки на другие веб-сайты или другие интернет-источники.
Компания не может контролировать эти веб-сайты и внешние источники, компания
не несет ответственности за предоставление или отображение этих веб-страниц
сайты и внешние источники, и не может нести ответственность за содержание,
реклама, продукты, услуги или любые другие материалы, доступные на сайте или
из этих веб-сайтов или внешних источников.
</p><p class="moto-text_system_10"><br></p><p class="moto-text_214"><strong>Как мы используем вашу информацию</strong><br></p><p class="moto-text_system_10">
Наш веб-сайт использует данные, которые мы собираем, для трех основных целей: для работы
наш бизнес и обеспечить (в том числе улучшение и персонализацию)
услуги, которые мы предлагаем, для отправки сообщений. При выполнении этих задач
цели, мы объединяем данные, которые мы собираем через различные веб-сайты
услуги, которые вы используете, чтобы дать вам более плавный, последовательный и
персонализированный опыт. Тем не менее, чтобы повысить конфиденциальность, мы встроили
технологические и процедурные гарантии, предназначенные для предотвращения определенных данных
сочетания. Например, мы храним данные, которые мы собираем от вас, когда вы
проходят проверку подлинности (не входят в систему) отдельно от любой учетной записи
информация, которая непосредственно идентифицирует вас, например ваше имя, адрес электронной почты
адрес или номер телефона.
</p><p class="moto-text_system_10"><br></p><p class="moto-text_214"><strong>Обмена информацией</strong><br></p><p class="moto-text_system_10">
Мы делитесь своими персональными данными с вашего согласия или по мере необходимости для их заполнения
любая транзакция или предоставление любой услуги, которую вы запросили или авторизовали.
Например, мы делимся вашим контентом с третьими лицами, когда вы сообщаете нам об этом
так поступать. Когда вы предоставляете платежные данные для совершения покупки, мы будем
обмен платежными данными с банками и другими организациями, осуществляющими обработку платежей
операции или предоставление других финансовых услуг, а также за мошенничество
профилактика и снижение кредитного риска. Кроме того, мы делимся личным опытом
данные среди наших контролируемых филиалов и дочерних компаний. Мы тоже делимся
персональные данные с поставщиками или агентами, работающими от нашего имени для
цели, описанные в этом заявлении. Например, компании, которые мы наняли
для обеспечения поддержки обслуживания клиентов или оказания помощи в защите и
для обеспечения безопасности наших систем и сервисов может потребоваться доступ к персональным данным в следующих случаях:
чтобы обеспечить эти функции. В таких случаях эти компании должны:
соблюдайте наши требования к конфиденциальности и безопасности данных и не допускаются
использовать персональные данные, которые они получают от нас, для любых других целей. Мы можем
также раскрываются персональные данные в рамках корпоративной сделки, такой как
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="Privacy%20Policy_files/website.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="Privacy%20Policy_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
