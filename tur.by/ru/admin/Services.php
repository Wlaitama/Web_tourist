...
.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
<meta charset="utf-8">
        <title>Сервисы</title>
...
<meta property="og:type" content="website">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link rel="stylesheet" href="Services_files/assets.css">
        <style>
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Services_files/styles.css" id="moto-website-style">  
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_2">Мы заботимся о наших клиентах</p><h1 class="moto-text_system_5">Сервисы</h1></div>
</div>
...
<div data-widget-id="wid__image__5b025f3d73456" class="moto-widget moto-widget-image moto-preset-default moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img class="moto-widget-image-picture lazyloaded" data-id="187" title="" alt="" src="Home_files/images/отелль.jpg">
            </span>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_6">Отели</h3><p class="moto-text_system_10">&nbsp;</p><p class="moto-text_system_10">
    Мы заботимся о наших клиентах и делаем предварительное бронирование и транспортировку в отель. 
    Мы полностью меняем способ бронирования онлайн-отелей и услуг. 
    Наша система отфильтровывает лучшие цены и доступность.</p></div>
</div><div data-widget-id="wid__button__5b025f3d7391d" class="moto-widget moto-widget-button moto-preset-default moto-align-left moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="button">
            <a href="" data-action="page" class="moto-widget-button-link moto-size-medium moto-link"><span class="fa moto-widget-theme-icon"></span> <span class="moto-widget-button-label">ПРОСМОТРЕТЬ</span></a>
    </div></div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5b025f3d73c84" class="moto-widget moto-widget-image moto-preset-default moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img class="moto-widget-image-picture lazyloaded" data-id="186" title="" alt="" src="Home_files/images/экскурсия.jpg">
            </span>
            </div> 
</div>
 <div class="moto-widget moto-widget-row__column moto-cell col-sm-5" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_6">Экскурсия</h3><p class="moto-text_system_10">&nbsp;</p><p class="moto-text_system_10">
    Мы предоставляем широкий спектр туристических услуг, включая экскурсию и за г.Гродно. 
    Так же, если будет угодно, экскурсию можно будет заказать и на сайтах.</p></div>
</div>
        
    
        
            <div data-widget-id="wid__button__5b025f3d73f46" class="moto-widget moto-widget-button moto-preset-default moto-align-left moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="button">
            <a href="" data-action="page" class="moto-widget-button-link moto-size-medium moto-link"><span class="fa moto-widget-theme-icon"></span> <span class="moto-widget-button-label">ПРОСМОТРЕТЬ</span></a>
    </div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5b025f3d74179" class="moto-widget moto-widget-image moto-preset-default moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img class="moto-widget-image-picture lazyloaded" data-id="188" title="" alt="" src="Home_files/images/рест.jpg">
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_6">Рестораны</h3><p class="moto-text_system_10">&nbsp;</p><p class="moto-text_system_10">
    Прекрасно обученный персонал всегда готов предоставить нашим клиентам превосходный сервис. 
    Заказывать еду можно так же и в отели на сайтах.</p></div>
</div>
        
    
        
            <div data-widget-id="wid__button__5b025f3d74432" class="moto-widget moto-widget-button moto-preset-default moto-align-left moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="button">
            <a href="" data-action="page" class="moto-widget-button-link moto-size-medium moto-link"><span class="fa moto-widget-theme-icon"></span> <span class="moto-widget-button-label">ПРОСМОТРЕТЬ</span></a>
    </div> 
</div>
</div>
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="Services_files/website.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="Services_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
