...
<meta property="og:type" content="website">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link rel="stylesheet" href="FAQ_files/assets.css">
...
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="FAQ_files/styles.css" id="moto-website-style">
</head>
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_2">Хотите узнать больше?</p><h1 class="moto-text_system_5">F. A. Q.</h1></div>
</div>   
</div>
</div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
                    ...
                    <div class="moto-widget moto-widget-row__column moto-cell col-sm-10" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
    
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6">Здесь вы можете найти практические советы и ответы на свои вопросы!</h2></div>
...
<div id="wid__accordion__5c10249dae7e0" class="moto-widget moto-widget-accordion moto-widget_interactive moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto   moto-disabling_row-fixed set-row-gutter-0" data-widget="accordion" data-preset="default" data-close-others="">
    <div id="wid__accordion__5c10249dae7e0__content" class="moto-widget-accordion__wrapper">
                                    <div id="wid__accordion_item__5c10249dae85f" data-parent-id="wid__accordion__5c10249dae7e0" class="moto-widget moto-widget-accordion__item moto-widget_with-content-editor moto-widget-accordion__item_collapse-icon-right moto-widget-accordion__item_open" data-widget="accordion.item">
    <div class="moto-widget-accordion__header" data-widget-id="wid__accordion_item__5c10249dae85f">
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__header-title"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["vopros"] ?></span>
    ...
    <div class="moto-widget__content-wrapper moto-widget-accordion__content-wrapper" style="display: block;">
        <div id="wid__accordion_item__5c10249dae85f__content" class="moto-widget__content moto-widget-accordion__content ">
                                                <div data-widget-id="wid__text__5c10249dae8c7" class="moto-widget moto-widget-text moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_10"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["otvet"] ?></p></div>
</div>
                                                </div>
    </div>
</div>
                                                <div id="wid__accordion_item__5c10249dae931" data-parent-id="wid__accordion__5c10249dae7e0" class="moto-widget moto-widget-accordion__item moto-widget_with-content-editor moto-widget-accordion__item_collapse-icon-right moto-entertainment__playing_disabled" data-widget="accordion.item">
    <div class="moto-widget-accordion__header" data-widget-id="wid__accordion_item__5c10249dae931">
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__header-title"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["vopros"] ?></span>
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__collapse-icon fa fa-fw" aria-hidden="true"></span>
            </div>
    <div class="moto-widget__content-wrapper moto-widget-accordion__content-wrapper" style="display: none;">
        <div id="wid__accordion_item__5c10249dae931__content" class="moto-widget__content moto-widget-accordion__content moto-entertainment__animation_disabled moto-entertainment__animation_ignore-visibility">
                                                <div data-widget-id="wid__text__5c10249dae993" class="moto-widget moto-widget-text moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_10"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["otvet"] ?></p></div>
</div>
                                                </div>
    </div>
</div>
                                                <div id="wid__accordion_item__5c10249dae9f9" data-parent-id="wid__accordion__5c10249dae7e0" class="moto-widget moto-widget-accordion__item moto-widget_with-content-editor moto-widget-accordion__item_collapse-icon-right moto-entertainment__playing_disabled" data-widget="accordion.item">
    <div class="moto-widget-accordion__header" data-widget-id="wid__accordion_item__5c10249dae9f9">
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__header-title"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["vopros"] ?></span>
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__collapse-icon fa fa-fw" aria-hidden="true"></span>
            </div>
    <div class="moto-widget__content-wrapper moto-widget-accordion__content-wrapper" style="display: none;">
        <div id="wid__accordion_item__5c10249dae9f9__content" class="moto-widget__content moto-widget-accordion__content moto-entertainment__animation_disabled moto-entertainment__animation_ignore-visibility">
                                                <div data-widget-id="wid__text__5c10249daea5a" class="moto-widget moto-widget-text moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_10"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["otvet"] ?></p></div>
</div>
                                                </div>
    </div>
</div>
                                                <div id="wid__accordion_item__5c10249daeabe" data-parent-id="wid__accordion__5c10249dae7e0" class="moto-widget moto-widget-accordion__item moto-widget_with-content-editor moto-widget-accordion__item_collapse-icon-right moto-entertainment__playing_disabled" data-widget="accordion.item">
    <div class="moto-widget-accordion__header" data-widget-id="wid__accordion_item__5c10249daeabe">
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__header-title"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["vopros"] ?></span>
                            <span class="moto-widget-accordion__header-item moto-widget-accordion__collapse-icon fa fa-fw" aria-hidden="true"></span>
            </div>
    <div class="moto-widget__content-wrapper moto-widget-accordion__content-wrapper" style="display: none;">
        <div id="wid__accordion_item__5c10249daeabe__content" class="moto-widget__content moto-widget-accordion__content moto-entertainment__animation_disabled moto-entertainment__animation_ignore-visibility">
                                                <div data-widget-id="wid__text__5c10249daeb1f" class="moto-widget moto-widget-text moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="text" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_10"><?php $result = mysqli_query($link, "SELECT * FROM table_faq WHERE faq_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["otvet"] ?></p></div>
</div>
                                                </div>
    </div>
</div>
