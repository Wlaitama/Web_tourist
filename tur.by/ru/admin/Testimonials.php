...
<meta property="og:type" content="website">
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link rel="stylesheet" href="Testimonials_files/assets.css">
...
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Testimonials_files/styles.css" id="moto-website-style">
</head>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_1"><span class="moto-color1_3"></span><a href="Hpme.php" data-action="page" data-id="1" class="moto-link"><span class="moto-color1_3">GrodnoTravel</span></a><span class="moto-color1_3"></span><br></p></div>
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_2">Отзывы клиентов и впечатления</p><h1 class="moto-text_system_5">Рекомендациия</h1></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_8">
    <?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?><br></p></div>
...
<div data-widget-id="wid__image__5c1024d9e27b3" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img src="Testimonials_files/<?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyloaded" data-id="196" title="" alt="">
            </span>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["ima"] ?></strong><br></p><p class="moto-text_215"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["chto"] ?><br></p></div>
</div></div>
...
</div><div data-widget-id="wid__divider_horizontal__5c1024d9e3021" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_8">
    <?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></p></div>
</div><div class="moto-widget moto-widget-row row-gutter-0 moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aasa" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5c1024d9e35a3" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img src="Testimonials_files/<?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyloaded" data-id="197" title="" alt="">
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong></strong><strong><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["ima"] ?></strong><strong></strong><br></p><p class="moto-text_215"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["chto"] ?></p></div>
</div>
...
</div><div data-widget-id="wid__divider_horizontal__5c1024d9e389d" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_8">
    <?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></p></div>
</div><div class="moto-widget moto-widget-row row-gutter-0 moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aasa" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5c1024d9e3b35" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img src="Testimonials_files/<?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyloaded" data-id="198" title="" alt="" >
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["ima"] ?></strong><br></p><p class="moto-text_215"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["chto"] ?></p></div>
</div>
...
</div><div data-widget-id="wid__divider_horizontal__5c1024d9e3e1a" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_8"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></p></div>
</div><div class="moto-widget moto-widget-row row-gutter-0 moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aasa" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5c1024d9e4093" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img src="Testimonials_files/<?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="199" title="" alt="">
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong></strong><strong><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["ima"] ?></strong><strong></strong><br></p><p class="moto-text_215"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["chto"] ?></p></div>
</div>
...
</div><div data-widget-id="wid__divider_horizontal__5c1024d9e4362" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_8"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='5' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></p></div>
</div><div class="moto-widget moto-widget-row row-gutter-0 moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aaaa" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid__image__5c1024d9e45dd" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img src="Testimonials_files/<?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='5' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="200" title="" alt="">
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong></strong><strong><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='5' "); $food = mysqli_fetch_assoc($result); echo $food["ima"] ?></strong><strong></strong><br></p><p class="moto-text_215"><?php $result = mysqli_query($link, "SELECT * FROM table_otziv WHERE otziv_id='5' "); $food = mysqli_fetch_assoc($result); echo $food["chto"] ?></p></div>
</div></div></div>
    </div>
</div></div></div>
    </div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_216"><a href="tel:1234567890" data-action="call" class="moto-link"><span class="moto-color5_5">+375(33)12345678</span></a><span class="moto-color5_5">&nbsp;&nbsp; <strong>24/7</strong></span><span class="moto-color5_5"> </span><span class="moto-color4_3">Специализированная Поддержка Клиентов</span></p></div>
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="Testimonials_files/website.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="Testimonials_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
