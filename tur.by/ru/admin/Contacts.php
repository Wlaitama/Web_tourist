...
</style><link type="text/css" rel="stylesheet" href="Contacts_files/css.css"><style>.gm-ui-hover-effect{opacity:.6}.gm-ui-hover-effect:hover{opacity:1}
...
[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}
...
<link rel="canonical" href="Contacts.php">
<meta property="og:title" content="Contacts">
<meta property="og:type" content="website">
                            <meta http-equiv="X-UA-Compatible" content="IE=Edge">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    
            <link rel="stylesheet" href="Contacts_files/assets.css">
        <style>
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Contacts_files/styles.css" id="moto-website-style">
             
<script type="text/javascript" charset="UTF-8" src="Contacts_files/common.js"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/util.js"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/map.js"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/marker.js"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/onion.js"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/ViewportInfoService.GetViewportInfo"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/vt"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/controls.js"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/AuthenticationService.Authenticate"></script>
<script type="text/javascript" charset="UTF-8" src="Contacts_files/QuotaService.RecordEvent"></script>
...
<div data-widget-id="wid__menu__5e43a18592daf" class="moto-widget moto-widget-menu moto-preset-2 moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="2" data-widget="menu">
    ...
    <a href="About_us.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-submenu moto-link">О нас<span class="famoto-widget-menu-link-arrow"></span></a>
    ...
    <a href="Events.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-submenu moto-link">Факты<span class="famoto-widget-menu-link-arrow"></span></a>
                <ul class="moto-widget-menu-sublist">
                    <li class="moto-widget-menu-item">
    <a href="Blog.php" data-action="blog.index" class="moto-widget-menu-link moto-widget-menu-link-level-3 moto-link">Блог</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="Contacts.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-3 moto-widget-menu-link-active moto-link">Контакты</a>
        </li>
            </ul>
    ...
    <a href="Contects.php" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-active moto-link">Контакты</a>
        </li>        </ul>
    </div></div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h1 class="moto-text_system_5">Связаться с нами</h1></div>
</div>
...
</div><div class="moto-widget moto-widget-block moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="block" data-spacing="laaa" style="" data-bg-position="left top" data-draggable-disabled="">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_normal">Готовы обсудить все лично?</p><h2 class="moto-text_system_6">Не стесняйтесь поддерживать контакт с нами.</h2></div>
</div>
...
</div><div class="moto-widget moto-widget-row row-fixed moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aama" style="" data-bg-position="left top" data-draggable-disabled="">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_6"><span class="moto-color1_3"><span class="far fa-map"></span></span></p></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_214"><strong>Адрес</strong></h3><p class="moto-text_system_10">231100 ул.Огинского 26</p></div>
</div>
</div>
</div>
</div>
...
<div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
<div class="moto-widget moto-widget-row row-gutter-0 moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="sasa" data-draggable-disabled="" style="" data-bg-position="left top">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_6"><span class="moto-color1_3"><span class="fa"></span></span><br></p></div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="" data-draggable-disabled="" data-visible-on="-">
    <div class="moto-widget-text-content moto-widget-text-editable" aria-multiline="true"><p class="moto-text_214"><span class="moto-color3_3"><strong>Телефон</strong></span></p><p class="moto-text_system_10"><a data-action="call" class="moto-link" href="tel:1234567890">+375(29)12-34-567</a><br></p><p class="moto-text_system_10"><a data-action="call" class="moto-link" href="tel:1234567890"></a><a href="tel:1234567890" data-action="call" class="moto-link">+375(33)12-34-567</a></p></div>
</div>
...
<div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_6"><span class="moto-color1_3"><span class="far fa-envelope-open"></span></span></p></div>
</div>
...
<div class="moto-widget moto-widget-row__column moto-cell col-xs-10" data-widget="row.column" data-bgcolor-class="" data-container="container" style="" data-bg-position="left top">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_214"><strong>E-mail</strong></p><p class="moto-text_system_10"><a href="mailto:turizm@mail.ru" data-action="mail" class="moto-link">turizm@mail.ru</a></p></div>
</div></div>
</div>
    </div>
</div></div>
...
</div><div id="wid_1544561792_2jgmbs1js" class="moto-widget moto-widget-google-map-pro moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto " data-widget="google_map_pro">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1719.847916571829!2d23.838086757121282!3d53.68277986754045!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46dfd624a775ceb7%3A0x3ff475cc68f7bff4!2z0JPRgNC-0LTQvdC10L3RgdC60LjQuSDQvtCx0LvQsNGB0YLQvdC-0Lkg0KbQtdC90YLRgCDRgtGD0YDQuNC30LzQsCDQuCDQutGA0LDQtdCy0LXQtNC10L3QuNGP!5e0!3m2!1sru!2sby!4v1590332170598!5m2!1sru!2sby" width="1900" height="600" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
</div>
        </div>
    </div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="sasa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_216"><a href="tel:1234567890" data-action="call" class="moto-link"><span class="moto-color5_5">+375(33)1234567</span></a><span class="moto-color5_5">&nbsp;&nbsp; <strong>24/7</strong></span><span class="moto-color5_5"> </span><span class="moto-color4_3">Специальная Поддержка Клиентов</span></p></div>
...
<div data-widget-id="wid__button__5b025eb15f85c" class="moto-widget moto-widget-button moto-preset-default moto-align-right moto-align-right_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="button">
            <a href="#" data-action="popup" data-popup-id="8" class="moto-widget-button-link moto-size-small moto-link"><span class="fa moto-widget-theme-icon"></span> <span class="moto-widget-button-label">ЗАКАЗАТЬ ПУТЕШЕСТВИЕ</span></a>
    </div></div>
...
Бронирование, отзывы и советы по отелям, курортам, рейсам, аренде жилья, туристическим пакетам и многое другое!<br></p></div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_13"><a href="Home.php" data-action="page" data-id="1" class="moto-link">Гланвая</a><br><a href="About_us.php" data-action="page" data-id="9" class="moto-link">О нас</a><br><a href="Tours" data-action="page" data-id="10" class="moto-link">Путешествие</a><br></p></div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_13"><a href="Testimonials.php" data-action="page" data-id="17" class="moto-link">Рекомендации</a><br><a href="Blog.php" data-action="blog.index" data-id="3" class="moto-link">Блог</a><br><a href="Contacts.php" data-action="page" data-id="14" class="moto-link">Контакты</a><br></p></div>
</div></div>
...
<script src="FAQ_files/website.js" type="text/javascript" data-cfasync="false"></script>
