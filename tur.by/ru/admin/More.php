...
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="More_files/styles.css" id="moto-website-style"> 
</head>
...
<div class="moto-widget moto-widget-row row-fixed moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto moto-justify-content_center" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="" data-bg-position="left top" data-visible-on="-">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h1 class="moto-text_system_5">Подробней</h1></div>
</div></div></div>
    </div>
</div></div>
        </div>
    ...
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                    ...
                    <img src="Tours_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
    ...
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["title"] ?></h2></div>
        ...
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></span></p></div>
    </div>    
        </div>
        <div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                            <span class="moto-widget-image-link">
                    <img src="Tours_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
                </div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["title"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></span></p></div>
    </div>    
        </div>
        <div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                            <span class="moto-widget-image-link">
                    <img src="Tours_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
                </div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["title"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></span></p></div>
    </div>    
        </div>
        <div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                            <span class="moto-widget-image-link">
                    <img src="Tours_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
                </div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["title"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_mesto WHERE mesto_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["text"] ?></span></p></div>
    </div>    
        </div>
    </div>
</div></div>           
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="More_files/website.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="More_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
