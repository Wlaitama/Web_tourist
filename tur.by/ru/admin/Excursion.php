...
?>
<!DOCTYPE html>
<html data-ng-app="website" lang="en">
    <head>
<meta charset="UTF-8">
...
<link rel="canonical" href="Excursion.php">
<meta property="og:title" content="Excursion">
<meta property="og:type" content="website">
                            <meta http-equiv="X-UA-Compatible" content="IE=Edge">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    
            <link rel="stylesheet" href="Excursion_files/assets.css"> 
        <style>
@import url(//fonts.googleapis.com/css?family=Lora:regular,italic,700,700italic|Merriweather:300,300italic,regular,italic,700,700italic,900,900italic|Mr+Dafoe:regular|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic&subset=latin-ext,cyrillic,cyrillic-ext,vietnamese,latin,greek,greek-ext);
        ...
        <link rel="stylesheet" href="Excursion_files/styles.css" id="moto-website-style">
...
<body class="moto-background moto-website_live">
    ...
    <div class="page">
        ...
        <header id="section-header" class="header moto-section" data-widget="section" data-container="section">
                                    <div class="moto-widget moto-widget-block moto-bg-color5_5 moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="block" data-spacing="sasa" data-bg-position="left top">
...
</div><div class="moto-widget moto-widget-container undefined moto-container_header_5e43a1fc2 moto-sticky__bootstrapped" data-widget="container" data-container="container" data-css-name="moto-container_header_5e43a1fc2" data-bg-position="left top" data-moto-sticky="{}">
...
<div class="moto-widget moto-widget-row row-fixed moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto moto-justify-content_center" data-grid-type="sm" data-widget="row" data-spacing="aaaa" data-bg-position="left top" data-visible-on="-">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
                    ...
                    <div class="moto-widget moto-widget-row__column moto-cell col-sm-2" data-widget="row.column" data-bgcolor-class="" data-container="container" data-bg-position="left top">
...
</div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-10" data-widget="row.column" data-bgcolor-class="" data-container="container" data-bg-position="left top">
...
<div class="profile">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><h1 class="moto-text_system_5">Экскурсии</h1></div>
</div></div></div>
    </div>
</div></div>
        </div>
    </div>
</div><div class="moto-widget moto-widget-block moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto" data-widget="block" data-spacing="lala" style="background-color:;" data-draggable-disabled="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="moto-cell col-sm-12" data-container="container">
                        ...
                        <div class="moto-widget moto-widget-row row-fixed moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" data-draggable-disabled="" style="" data-bg-position="left top">
    ...
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                    ...
                    <img src="Excursion_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
    ...
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["nazv"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["marsh"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color1_4 moto-text-vrema"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["vrema"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color_custom5 moto-text-cena"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='1' "); $food = mysqli_fetch_assoc($result); echo $food["cena"] ?> Br</span></p>
    ...
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                            <span class="moto-widget-image-link">
                    <img src="Excursion_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
                </div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["nazv"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["marsh"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color1_4 moto-text-vrema"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='2' "); $food = mysqli_fetch_assoc($result); echo $food["vrema"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color_custom5 moto-text-cena"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["cena"] ?> Br</span></p></div>
    </div>    
        </div>
        <div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                            <span class="moto-widget-image-link">
                    <img src="Excursion_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
                </div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["nazv"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["marsh"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color1_4 moto-text-vrema"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["vrema"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color_custom5 moto-text-cena"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='3' "); $food = mysqli_fetch_assoc($result); echo $food["cena"] ?> Br</span></p></div>
    </div>    
        </div>
        <div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div data-widget-id="wid__image__5b025cfec4dab" class="moto-widget moto-widget-image moto-preset-default  moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="image">
                            <span class="moto-widget-image-link">
                    <img src="Excursion_files/images/<?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["image"] ?>" class="moto-widget-image-picture lazyload" data-id="161" alt="">
                </span>
                </div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-container="container" data-bg-position="left top">
    <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asss">
        <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["nazv"] ?></h2></div>
    </div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-small moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="asas">
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color3_3 moto-text-text"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["marsh"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color1_4 moto-text-vrema"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["vrema"] ?></span></p></div>
        <div class="moto-widget-text-content moto-widget-text-editable"><span class="moto-color_custom5 moto-text-cena"><?php $result = mysqli_query($link, "SELECT * FROM table_exurs WHERE exurs_id='4' "); $food = mysqli_fetch_assoc($result); echo $food["cena"] ?> Br</span></p></div>
    </div>    
        </div>
    </div>
</div></div>           
    ...
    <footer id="section-footer" class="footer moto-section moto-sticky__bootstrapped" data-widget="section" data-container="section" data-moto-sticky="{mode:'smallHeight', direction:'bottom', mobile: 0}">
                                <div class="moto-widget moto-widget-block moto-bg-color2_4 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="block" data-spacing="aaaa" data-bg-position="left top">
...
</div><div class="moto-widget moto-widget-row row-fixed moto-justify-content_center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" data-bg-position="left top">
    
    <div class="container-fluid">
        <div class="row" data-container="container">
            
                
                    <div class="moto-widget moto-widget-row__column moto-cell col-sm-4" data-widget="row.column" data-bgcolor-class="" data-container="container" data-bg-position="left top">
...
</div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-bgcolor-class="" data-container="container" data-bg-position="left top">
...
</div></div><div class="moto-widget moto-widget-row__column moto-cell col-sm-2" data-widget="row.column" data-bgcolor-class="" data-container="container" data-bg-position="left top">
...
<div data-widget-id="wid__button__5b025eb15f85c" class="moto-widget moto-widget-button moto-preset-default moto-align-right moto-align-right_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="button">
...
</div><div class="moto-widget moto-widget-block moto-bg-color2_3 moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="block" data-spacing="maaa" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
                    ...
                    <div class="moto-widget moto-widget-row__column moto-cell col-sm-6" data-widget="row.column" data-bgcolor-class="" data-container="container" data-bg-position="left top">
...
<div data-moto-widget-callback="" class="moto-widget-callback moto-widget-callback_closed moto-preset-default">
...
</div>                <script src="Excursion_files/website_002.js" type="text/javascript" data-cfasync="false"></script>
    ...
    <script src="Excursion_files/website.js" type="text/javascript" data-cfasync="false"></script>
